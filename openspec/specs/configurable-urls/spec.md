# Capability: Configurable URLs

## Overview
This capability allows users to configure custom Perfetto UI URLs where the extension will automatically inject its scripts and enable its features. This supports internal deployments and non-standard Perfetto UI instances.
